...
void GameAI_PLAYING_EMM::setResultFileName(string s) { resultFileName = s; }

void GameAI_PLAYING_EMM::setInitialSeed(unsigned int seed) { initialSeed = seed; }

void GameAI_PLAYING_EMM::setDumpable(const bool isDump) { isDumpResult = isDump; }
...
void GameAI_TDLearning::getScoresFromTuples(board_t b) { t.getScoresFromTuples(b); };
