...
public:
        ...
        void saveResultToFile(int mode){
                ...
                if(mode == 0)out.open("trainingResult(Binary)_before8192.txt", ios::out |
ios::binary); if(mode == 1)out.open("trainingResult(Binary)_8192Appear.txt", ios::out |
ios::binary); if(mode == 2)out.open("trainingResult(Binary)_16384Appear.txt", ios::out |
ios::binary); if(mode == 3)out.open("trainingResult(Binary)_16384_8192Appear.txt", ios::out |
ios::binary); if(mode == 4)out.open("trainingResult(Binary)_16384_8192_4096Appear.txt", ios::out |
ios::binary); if(mode == 5)out.open("trainingResult(Binary)_32768Appear.txt", ios::out |
ios::binary); if(mode == 6)out.open("trainingResult(Binary)_32768_8192Appear.txt", ios::out |
ios::binary); if(mode == 7)out.open("trainingResult(Binary)_32768_8192_4096Appear.txt", ios::out |
ios::binary);


                for(int i = 0; i < tuples.size(); i++){
                        out.write(reinterpret_cast<char*>(tuples[i]->getTupleDataPointer()),
(tuples[i]->getSizeOfTuple())*sizeof(double));
                }
                out.close();
        };
        ...
        void getResultFromFile(int mode){
                ...
                if(mode == 0)in.open("trainingResult(Binary)_before8192.txt", ios::in |
ios::binary); if(mode == 1)in.open("trainingResult(Binary)_8192Appear.txt", ios::in | ios::binary);
                if(mode == 2)in.open("trainingResult(Binary)_16384Appear.txt", ios::in |
ios::binary); if(mode == 3)in.open("trainingResult(Binary)_16384_8192Appear.txt", ios::in |
ios::binary); if(mode == 4)in.open("trainingResult(Binary)_16384_8192_4096Appear.txt", ios::in |
ios::binary); if(mode == 5)in.open("trainingResult(Binary)_32768Appear.txt", ios::in | ios::binary);
                if(mode == 6)in.open("trainingResult(Binary)_32768_8192Appear.txt", ios::in |
ios::binary); if(mode == 7)in.open("trainingResult(Binary)_32768_8192_4096Appear.txt", ios::in |
ios::binary);

                for(int i = 0; i < tuples.size(); i++){
                        in.read(reinterpret_cast<char*>(tuples[i]->getTupleDataPointer()),
(tuples[i]->getSizeOfTuple())*sizeof(double));
                }
                in.close();
        };
